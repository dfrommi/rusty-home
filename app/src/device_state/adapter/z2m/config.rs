    ...
    vec![
        ...
        (
            ...
            Z2mChannel::ClimateSensor(
                Temperature::Radiator(Radiator::LivingRoomSmall),
                RelativeHumidity::Radiator(Radiator::LivingRoomSmall),
            ),
        ),
        (
            "living_room/temp_sensor_radiator_big",
            Z2mChannel::ClimateSensor(
                Temperature::Radiator(Radiator::LivingRoomBig),
                RelativeHumidity::Radiator(Radiator::LivingRoomBig),
            ),
        ),
        (
        ...
        (
            ...
            Z2mChannel::ClimateSensor(
                Temperature::Radiator(Radiator::Bedroom),
                RelativeHumidity::Radiator(Radiator::Bedroom),
            ),
        ),
        (
            "bedroom/outer_wall",
        ...
        (
            ...
            Z2mChannel::ClimateSensor(
                Temperature::Radiator(Radiator::RoomOfRequirements),
                RelativeHumidity::Radiator(Radiator::RoomOfRequirements),
            ),
        ),
        (
        ...
        (
            ...
            Z2mChannel::ClimateSensor(
                Temperature::Radiator(Radiator::Bathroom),
                RelativeHumidity::Radiator(Radiator::Bathroom),
            ),
        ),
        (
            "kitchen/temp_sensor",
        ...
        (
            ...
            Z2mChannel::ClimateSensor(
                Temperature::Radiator(Radiator::Kitchen),
                RelativeHumidity::Radiator(Radiator::Kitchen),
            ),
        ),
        //
        // THERMOSTATS
